# alb-PruebaSpring![Captura de pantalla 2023-04-21 095131]
Hay que tener en cuenta que he usado mi base de datos sql local en vez de tener el data.sql en el proyecto mismo, asi que hara falta coger el data.sql y introducirlo en tu misma base de datos local i introducir los datos de tu base de datos local en el archivo de properties (https://user-images.githubusercontent.com/51365249/233610107-bba17db6-e5ed-4da2-a44a-9294a60f9272.png)
